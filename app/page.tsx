	...
	const services = [
		{
			...
			title: "Air Freight",
			description:
				"Fast and secure air cargo services for time-sensitive shipments to global destinations.",
		},
		{
			icon: Package,
			title: "Cargo Services",
			description:
				"Comprehensive cargo handling for household goods and commercial loads with full tracking.",
		},
		{
			icon: Globe,
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
							<div>
								...
								<p className="text-lg opacity-90 mb-8 leading-relaxed">
									Dexter Logistics connects Pakistan to the
									world. From household goods to commercial
									loads, we deliver with complete peace of
									mind. Our signature DDP service means no
									hidden costs, no customs tension—just
								...
								<div className="flex flex-col sm:flex-row gap-4">
									...
									<Button
										size="lg"
										variant="outline"
										className="rounded-2xl border-secondary-foreground text-secondary-foreground hover:bg-primary-foreground/10 hover:text-secondary-foreground/90 hover:border-secondary-foreground/90 bg-transparent"
									>
										Learn More
									</Button>
								</div>
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
								Comprehensive logistics solutions tailored to
								your shipping needs
							</p>
						</div>
				...
				>
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
								We're committed to making international shipping
				...
				>
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
								We serve major destinations across the globe
								with reliable, efficient service
							</p>
						</div>
